...
from .views import *
from mainapp.distill import (get_authors, get_quotes, get_topics, get_author_paginator, get_topic_paginator)
...
urlpatterns = [
    ...
    distill_path("authors/starts-with-<str:alphabet>/", AuthorListView.as_view(), name="authors_by_alphabet"),
