...
urlpatterns = [
    ...
    path("topics/<slug:topic_name>/page/<int:page>/", TopicDetailView.as_view(), name="topic_paginator"),
    path("authors/<slug:author_name>/", QuoteDetailView.as_view(), name="Author_detail"),
    path("authors/<slug:author_name>/page/<int:page>/", QuoteDetailView.as_view(), name="author_paginator"),
